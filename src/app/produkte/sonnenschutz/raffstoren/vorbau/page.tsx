    ...
    <div className="mx-auto max-w-7xl px-4 py-10 md:py-14">
      ...
      <section className="mb-14 rounded-2xl border border-zinc-200 bg-white p-8">
        ...
        <ul className="mt-4 grid gap-2 text-sm text-zinc-700 md:grid-cols-2">
          <li className="rounded-lg bg-brand-light px-3 py-2">Außenrevision – servicefreundlich</li>
          <li className="rounded-lg bg-brand-light px-3 py-2">Kombinierbar mit Insektenschutz</li>
          <li className="rounded-lg bg-brand-light px-3 py-2">Motor-/Funkantriebe + Smart-Home möglich</li>
          <li className="rounded-lg bg-brand-light px-3 py-2">Viele Farben & Strukturen – auch Sonderfarben</li>
          <li className="rounded-lg bg-brand-light px-3 py-2">Wahlweise C-, Z- oder CDL-Lamellen</li>
          <li className="rounded-lg bg-brand-light px-3 py-2">Sehr gute Wärmedämmwerte durch außenliegende Montage</li>
        </ul>
      </section>
