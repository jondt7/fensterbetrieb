    ...
    <div className="mx-auto max-w-7xl px-4 py-10 md:py-14">
      ...
      <section className="mb-14 rounded-[8px] border border-zinc-200 bg-white p-8">
        ...
        <ul className="mt-4 grid gap-2 text-sm text-zinc-700 md:grid-cols-2">
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Revision außen – schnelle Wartung ohne Innenarbeiten</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Sehr gute Dämmung durch Aufsatzbauweise</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Kompatibel mit Insektenschutz</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Motor, Funk, App; Automatik mit Sonnen-/Windsensor</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">CDL als Premium-Lamelle für hohe Blickdichtheit & Windstabilität</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Viele Farben & Strukturen der sichtbaren Teile</li>
        </ul>
      </section>
