    ...
    <div className="mx-auto max-w-7xl px-4 py-10 md:py-14">
      ...
      <section className="mb-12 rounded-[8px] border border-zinc-200 bg-white p-6">
        ...
        <ul className="mt-3 grid gap-2 text-sm text-zinc-700 md:grid-cols-2">
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Motor-/Funkantrieb, App-Steuerung, Automatik mit Sonnen-/Windsensor</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Solar-Antrieb ohne Kabel – ideal zur Nachrüstung</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Integrierbarer Insektenschutz möglich</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Außenrevision für servicefreundliche Wartung</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Viele Farben/Strukturen, farblich abgestimmte Sichtteile</li>
          <li className="rounded-[8px] bg-brand-light px-3 py-2">Auf Wunsch erhöhte Einbruchhemmung/ Hochschiebehemmung</li>
        </ul>
      </section>
      ...
      <section className="rounded-[8px] border border-brand bg-white p-8 shadow-sm">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          <Link
            ...
            className="inline-flex items-center rounded-[8px] border border-accent px-5 py-3 text-sm font-semibold text-accent transition hover:bg-accent hover:text-accent-foreground"
          >
