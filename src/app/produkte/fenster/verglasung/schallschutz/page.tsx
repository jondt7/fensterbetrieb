    ...
    <div className="mx-auto max-w-7xl px-4 py-10 md:py-14">
      ...
      <section className="rounded-[8px] border border-brand bg-white p-8 shadow-sm">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          <Link href="/produkte/fenster/verglasung/waermeschutz" className="inline-flex items-center rounded-[8px] border border-brand-dark px-5 py-3 text-sm font-semibold text-brand-dark hover:bg-brand-light">Wärmeschutz</Link>
