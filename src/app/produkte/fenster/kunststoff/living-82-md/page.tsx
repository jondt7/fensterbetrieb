    ...
    <div className="mx-auto max-w-7xl px-4 py-10 md:py-14">
      ...
      <section className="rounded-2xl border border-brand bg-white p-8 shadow-sm">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          <Link href="/produkte/fenster/kunststoff/living-82-as" className="inline-flex items-center rounded-xl border border-brand-dark px-5 py-3 text-sm font-semibold text-brand-dark transition hover:bg-brand-light">
